        ...
        <Router>
            <div class="relative min-h-dvh flex flex-col bg-[#050505] text-neutral-200 antialiased selection:bg-emerald-500/30 selection:text-emerald-200">
                ...
                <div class="fixed inset-0 z-0 pointer-events-none">
                    ...
                    <div class="absolute left-0 right-0 top-[-10%] h-[500px] w-full rounded-full bg-[radial-gradient(circle_farthest-side,rgba(6,182,212,0.08),rgba(255,255,255,0))] blur-[100px]"></div>
                ...
                <div class="relative z-10 flex flex-col flex-1">
                    ...
                    <ToastProvider>
                        <main class="flex-1 relative">
                            ...
                            <div class="mx-auto max-w-6xl px-6 sm:px-8 py-12">
